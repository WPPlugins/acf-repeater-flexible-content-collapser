...
if( !class_exists('acf_collapse_fields') ) :

class acf_collapse_fields {
	...
	*/
	...
	function acf_dependent_plugin_notice() {
		echo '<div class="error"><p>' . sprintf( __('%1$s requires ACF PRO v%2$s or higher to be installed and activated.', 'acf-collapse-fields'), $this->settings['plugin'], $this->settings['min_acf_version']) . '</p></div>';
	}
